...
with tab1:
    ...
    if run_btn:
        ...
        # ── Disclaimer price-volume tradeoff ──────────────────────────────────
...
with tab2:
    ...
    st.markdown(
        "**Interpretasi:** Nilai 0.19 artinya ketika SKU aggressor promo, "
        "SKU victim demand-nya ~19% lebih rendah dari expected baseline. "
...
with tab3:
    ...
    with col_b:
        ...
        fig_qty.update_layout(height=520,
                              yaxis={'categoryorder':'total ascending'},
                              yaxis_tickfont_size=9)
